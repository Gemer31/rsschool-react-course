...
describe('Card details component', () => {
  ...
  it('Ensure that clicking the close button hides the component. Verify that the component renders the specified number of cards', async () => {
    const router = createMemoryRouter(routerConfig, {
      initialEntries: ['/'],
    });
    render(<RouterProvider router={router} />);
    ...
    expect(organizationsElements).toHaveLength(10);
